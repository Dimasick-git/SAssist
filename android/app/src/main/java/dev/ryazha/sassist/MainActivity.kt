                ...
                AnimatedContent(
                    ...
                    when (stage) {
                        ...
                        Stage.Chats -> ChatsListScreen(
                            ...
                            connLastError = state.connLastError,
                            presence = state.presenceByChannel, preview = { vm.lastPreview(it) },
                            onOpen = { vm.openChannel(it) }, onReconnect = { vm.reconnectNow() }, onScripts = { vm.openScripts() },
                        ...
                        Stage.Chat -> ChatScreen(
                            ...
                            connState = state.connState, connLastError = state.connLastError, myUserId = state.userId,
                            ...
                            onChannel = { vm.openChannel(it) }, onReconnect = { vm.reconnectNow() }, onToggleCode = { vm.toggleCode() },
                            ...
                            onRecoverAttachment = { vm.recoverAttachment(it) },
                            onClearAttachmentNotice = { vm.clearAttachmentNotice() },
